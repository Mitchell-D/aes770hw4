...
class MultiHeadSelfAttention(tf.keras.layers.Layer):
    """
    Originally adapted from: https://github.com/faustomorales/vit-keras
    """
    ...
    def build(self, input_shape):
        ...
        if hidden_size % num_heads != 0:
            raise ValueError(
                f"embedding dimension = {hidden_size} should be "
                "divisible by number of heads = {num_heads}")
