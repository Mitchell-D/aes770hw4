...
Using the cumulative zarr arrays generated by `iter_agg.py`, generate
a series of npy files with "shuffled" footprints, such that the
number of footprints can be fit into memory.
